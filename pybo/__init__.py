...
def initialize_users_and_overseers(app):
    with app.app_context():
        ...
        users = ['김형민','김진부','강민성','김내오','김지오','김진숙','남선영','박봉임','박영수','서정현','성윤영','이은미','전재호','전지은','한주연','임정완','최소진',
                 '김경호','김진명','김귀덕','김미경','이예빛나','이윤남','이해안','이현숙','정병호','정우숙','차복순','최순남','최혜경',
                 '박정현','심지훈','권순자','김민교','김영길','모모코','박덕희','박홍숙','송현','이수림','전은희','한선욱','한성희','김지아',
                 '현승우','김경준','김연례','김재심','김진윤','김희숙','박원숙','박정숙','이성재','최예진','하혜자','함성희','허수봉','허숙자',
                 '김동석','이춘배','계현숙','김서현','김수석','김영식','김은주','김원숙','김정현','김지현','노경임','이영주','임애경','김재호','조경옥','최병선','김경희',
                 '김양호','안승현','김재희','박말호','박종서','박혜인','양현미','이혜경','임응진','장명희','장영숙','전상옥','정은실','조미선','최미례','문행숙','박시원','최현우',
                 '강신혜','문지원','최세욱','안병철','한순아','서종덕','배소연','유수아','서정우','김누리','황미희']


        overseers =['김형민','전재호','김경호','김진명','박정현','심지훈','한성희','현승우','김경준','김진윤','이성재','김동석','이춘배','김재호','정병호','김양호','안승현','박말호','최세욱','서정우','박종서']
